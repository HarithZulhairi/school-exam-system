        ...
        <div class="col-lg-6 text-center">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-5">
                    ...
                    <p class="text-muted mb-4">You have completed the exam.</p>
                    ...
                    <a href="{{ route('student.exams.history') }}" class="btn btn-outline-secondary px-4">
                        <i class="bi bi-arrow-left me-2"></i> Back to Exams List
                    </a>
                </div>
            </div>
        </div>
